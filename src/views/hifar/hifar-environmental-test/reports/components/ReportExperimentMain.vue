<!--
 * @Author: 马潭龙
 * @Date: 2021-11-23 10:46:54
 * @LastEditTime: 2021-11-23 11:47:27
 * @LastEditors: 马潭龙
 * @Descripttion: 报告生成-按试验查找-客户树
 * @FilePath: \hifar-platform-client\src\views\hifar\hifar-environmental-test\reports\components\ReportExperimentMain.vue
-->
<template>
  <div class="h-report-wrapper h-custom-layout">
    <r-l-layout class="h-custom-layout" :leftMinWidth="220">
      ...
      <div slot="right" style="background: #fff; width: 100%; height: 100%">
        ...
        <template v-else>
          <report-experiment-table ref="reportExperimentTable"></report-experiment-table>
        </template>
      </div>
    </r-l-layout>
  </div>
...
import ReportExperimentTable from './ReportExperimentTable.vue'
export default {
  data() {
    return {
      replaceFields: {
