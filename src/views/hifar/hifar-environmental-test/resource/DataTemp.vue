 ...
 * @LastEditTime: 2021-11-08 16:16:16
 * @LastEditors: Please set LastEditors
 * @Descripttion: 数据模板
 * @FilePath: \hifar-platform-client\src\views\hifar\hifar-physico-chemical\resource\DataTemp.vue
-->

<template>
  <div ref="pageWrapper" class="h-custom-layout" style="height: 100%; position: relative">
    <h-card fixed :bordered="true">
      <template slot="title"> 数据模板 </template>
      <h-search
        v-model="queryParam"
        slot="search-form"
        size="small"
