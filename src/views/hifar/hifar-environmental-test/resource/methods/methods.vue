  ...
  <div ref="pageWrapper" class="h-custom-layout" style="height: 100%; position: relative">
    <h-card fixed :bordered="true">
      ...
      <div slot="table-operator" style="border-top: 5px">
        <a-button v-has="'method:add'" size="small" @click="handleAdd" type="ghost-primary" icon="plus">新增</a-button>
        <a-button v-has="'method:privice'" size="small" type="ghost-warning" icon="export" @click="handleExportXls('标准管理')">导出</a-button>
