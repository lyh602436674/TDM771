<!--
 * @Author: 陈乾龙
 * @Date: 2021-08-30 16:26:15
 * @LastEditTime: 2021-08-31 09:53:38
 * @LastEditors: 陈乾龙
 * @Description: 流程实例详情
 * @FilePath: \hifar-platform-client\src\views\hifar\flowProcess\modules\FlowProcessInstanceModal.vue
-->
<template>
  <h-modal
    class="my-task-modal"
...
import TaskSelectUser from '@/views/hifar/myTask/components/TaskSelectUser.vue'
...
export default {
  ...
  methods: {
    show(record = {}) {
      ...
      // 这段是测试代码，可删除
      // this.model.formPath = '/hifar/flowProcess/FlowProcessList.vue'
      // this.model.formPath = '/hifar/hifar-physico-chemical/phhemism/components/EntrustDetail'
      // 测试代码结束
      this.$nextTick(async () => {
        this.getProcessInfo()
        this.visible = true
