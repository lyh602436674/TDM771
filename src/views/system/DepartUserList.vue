<template>
  <r-l-layout :leftMinWidth="300" style="height: 100%">
    <h-card :bordered="false" slot="left" style="height: 100%">
      <a-input-search
        size="small"
        slot="search-form"
        style="width: 100%"
        ...
        @search="onSearch"
      >
        <a-button type="primary" slot="enterButton" icon="search">搜索</a-button>
      </a-input-search>
      <div slot="table" style="background: #fff; padding-left: 16px; height: 100%; margin-top: 5px">
        <!-- 树-->
    ...
    <a-card :bordered="false" slot="right" style="height: 100%">
