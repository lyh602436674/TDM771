<template>
  <a-layout class="layout" :class="[device]">
    ...
    <a-layout
      ...
      :style="{ paddingLeft: fixSiderbar && isDesktop() ? `${!collapsed ? 208 : 80}px` : '0' }"
    >
      <!-- page header -->
      <global-header
        :mode="layoutMode"
        ...
        :style="{
          ...
          paddingTop: isDesktop()
            ? fixedHeader
              ...
              : '0'
            : '61px',
          position: fixedMultipage ? 'relative' : '',
          overflow: 'hidden',
        }"
      >
        <slot></slot>
...
export default {
  ...
  created() {
    ...
    //这里初始化
    this.collapsed = !this.$store.state.app.sidebar.opened
  },
  mounted() {
    /**
    ...
    //       {
    //         element: '.header',
    //         intro: '系统Header，包含系统消息，系统工具，用户基本菜单',
    //         position: 'left',
    //       },
    //       {
    //         element: '.user-wrapper',
    //         intro: '系统工具，系统通知和用户菜单',
    //       },
    //       {
    //         element: '.ant-layout-sider',
    //         intro: '系统菜单，这里是系统的主要功能区域，包含了系统内所有菜单',
    //       },
    //     ],
    //   })
    //   .start()
