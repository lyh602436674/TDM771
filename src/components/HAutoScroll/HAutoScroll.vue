<!--
 * @Author: 雷宇航
 * @Date: 2022-10-24 10:24:47
 * @fileName: HAutoScroll.vue
 * @FilePath: tdm724-client\src\components\HAutoScroll\HAutoScroll.vue
 * @Description: 自动滚动
-->
<template>
  <div ref="wrap">
...
<script>
import {animationFrame, arrayEqual, copyObj} from './util'
