<!--
 * @Author: 赵峰
 * @Date: 2021-08-24 10:29:04
 * @LastEditTime: 2021-08-24 16:17:12
 * @LastEditors: 赵峰
 * @Descripttion: 富文本
 * @FilePath: \hifar-platform-client\src\components\HEditor\index.vue
-->
<template>
    ...
    return {
      ...
      init: {
        ...
        images_upload_handler: (blobInfo, success) => {
          ...
          formData.append('biz', 'heditor')
          formData.append('heditor', '1')
          // 上传目前接口不对，后续更改
