...
## dist-20230718-v33
1. 报告推送内网/MES按钮图标区分开。
2. 产品增加时，产品代号做规则限制，只能输入六位数字，在配置参数中增加参数，可控制该规则是否开启
3. 实施过程中的“温度”、“湿度”，改成“试验室温度”、“试验室湿度”
4. 试验查询模块“实际开始时间”后增加“实际结束时间”字段
5. 试验任务模块高级查询查询条件增加“发起人”、“试验人员”字段
6. 试验任务模块，当前时间晚于预计结束时间，该条任务标红
7. 试验查询、试验设备、测试设备按钮权限
8. 试验条件结构化提交时根据配置参数校验是否必填
9. 后置处理增加常温保持参数
10. 试验任务和试验查询列表操作按钮重新排序，试前检查-试中检查-试验结果-试验数据-试后检查-异常记录，试验任务模块，除异常记录，依次填写，填过一个变色区分，试后填完后才可以点完成，试验查询模块可不依次填写
11. 报告批准时，可选择驳回的节点
12. 委托单项目信息选择后，试验名称默认不带入，由用户手动填写
13. 报告相关把复核修改为之前的批准